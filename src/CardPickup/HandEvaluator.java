...
/****************************************************
 * The HandEvaluator is a class that is used to rank hands numerically.  For PokerApp, the
 * hand ranking system goes as follows:
 * 
 ...
 **/
    public float rankHand( Hand h ) {
        ...
        if ( numCards == 1 ) {
            ...
            return rankHand( (Card)cardList.get(0), (Card)cardList.get(1), (Card)cardList.get(2) );
        } else if ( numCards == 4 ) {
            return rankHand( (Card)cardList.get(0), (Card)cardList.get(1), (Card)cardList.get(2), (Card)cardList.get(3) );
        } else if ( numCards == 5 ) {
            return rankHand( (Card)cardList.get(0), (Card)cardList.get(1), (Card)cardList.get(2), (Card)cardList.get(3), (Card)cardList.get(4) );
        } else {
            return 0.0f;   
        }
    }
...
/***************************
 * rankHand() is used to return the rank of a hand.  This version will take a single Card
 * and return its rank
 *
 * @param c1 The Card to rank
...
/***************************
 * rankHand() is used to return the rank of a hand.  This version will take a two Card
 * hand and return its rank
 *
 * @param c1 The first Card in the hand to rank
 * @param c2 The second Card in the hand to rank
...
/***************************
 * rankHand() is used to return the rank of a hand.  This version will take a three Card
 * hand and return its rank
 *
 * @param c1 The first Card in the hand to rank
 * @param c2 The second Card in the hand to rank
 * @param c3 The third Card in the hand to rank
 * @return The numerical rank of the cards
 *
 **/
...
/***************************
 * rankHand() is used to return the rank of a hand.  This version will take a four Card
 * hand and return its rank
 *
 * @param c1 The first Card in the hand to rank
 * @param c2 The second Card in the hand to rank
 * @param c3 The third Card in the hand to rank
 * @param c4 The fourth Card in the hand to rank
 * @return The numerical rank of the cards
 *
 **/
...
/***************************
 * rankHand() is used to return the rank of a hand.  This version will take a five Card
 * hand and return its rank
 *
 * @param c1 The first Card in the hand to rank
 * @param c2 The second Card in the hand to rank
 * @param c3 The third Card in the hand to rank
 * @param c4 The fourth Card in the hand to rank
 * @param c5 The fifth Card in the hand to rank
 * @return The numerical rank of the cards
 *
 **/
...
//    Five of a Kind
//
        } else if ( ( c1val == c2val ) && ( c1val == c3val ) && ( c1val == c4val ) &&  ( c1val == c5val ) ) {
            return 135.0f + c1val;
//
//    Straight Flush
//
...
/***************************
 * kicker() is used to return the rank of the kicker part of the hand.  This version will take
 * a single card kicker and return its rank
 *
 * @param c1 The first Card in the kicker
...
/***************************
 * kicker() is used to return the rank of the kicker part of the hand.  This version will take
 * a two card kicker and return its rank
 *
 * @param c1 The first Card in the kicker
 * @param c2 The second Card in the kicker
 * @return The numerical rank of the kicker cards
 *
 **/
    public float kicker( Card c1, Card c2 ) {
        ...
        return ( ( c1val > c2val ) ? ( (float)c1val + kicker( c2 ) ) / 15.0f : ( (float)c2val + kicker( c1 ) ) / 15.0f );
    }

/***************************
 * kicker() is used to return the rank of the kicker part of the hand.  This version will take
 * a three card kicker and return its rank
 *
 * @param c1 The first Card in the kicker
 * @param c2 The second Card in the kicker
 * @param c3 The third Card in the kicker
 * @return The numerical rank of the kicker cards
 *
 **/
...
/***************************
 * kicker() is used to return the rank of the kicker part of the hand.  This version will take
 * a four card kicker and return its rank.  Used for high card winning hand.
 *
 * @param c1 The first Card in the kicker
 * @param c2 The second Card in the kicker
 * @param c3 The third Card in the kicker
 * @param c4 The fourth Card in the kicker
 * @return The numerical rank of the kicker cards
 *
 **/
    public float kicker ( Card c1, Card c2, Card c3, Card c4 ) {
        ...
        return ( c4val + kicker( (Card)cardList.get(0), (Card)cardList.get(1), (Card)cardList.get(2) ) ) / 15.0f;
    }

/***************************
 * kicker() is used to return the rank of the kicker part of the hand.  This version will take
 * a five card kicker and return its rank.  Used for high card winning hand
 *
 * @param c1 The first Card in the kicker
 * @param c2 The second Card in the kicker
 * @param c3 The third Card in the kicker
 * @param c4 The fourth Card in the kicker
 * @param c5 The fifth Card in the kicker
 * @return The numerical rank of the kicker cards
 *
 **/
    public float kicker ( Card c1, Card c2, Card c3, Card c4, Card c5 ) {
        ...
        return ( c5val + kicker( (Card)cardList.get(0), (Card)cardList.get(1), (Card)cardList.get(2), (Card)cardList.get(3) ) ) / 15.0f;
    }

/***************************
 * isFlush() is used to determine if the hand is (or can be) a flush.  This version takes three Cards
 * as arguments and returns true if all are the same suit.
 *
 ...
 **/
    public boolean isFlush( Card c1, Card c2, Card c3 ) {
        return ( ( ( c1.getSuit() == c2.getSuit() ) && ( c1.getSuit() == c3.getSuit() ) ) ? true : false );
    }

/***************************
 * isFlush() is used to determine if the hand is (or can be) a flush.  This version takes four Cards
 * as arguments and returns true if all are the same suit.
 *
 * @param c1 The first Card
 * @param c2 The second Card
 ...
 **/
    public boolean isFlush( Card c1, Card c2, Card c3, Card c4 ) {
       return ( ( ( c1.getSuit() == c2.getSuit() ) && ( c1.getSuit() == c3.getSuit() ) && 
                  ( c1.getSuit() == c4.getSuit() ) ) ? true : false );
    }

/***************************
 * isFlush() is used to determine if the hand is (or can be) a flush.  This version takes five Cards
 * as arguments and returns true if all are the same suit.
 *
 * @param c1 The first Card
 * @param c2 The second Card
 ...
 **/
    public boolean isFlush( Card c1, Card c2, Card c3, Card c4, Card c5 ) {
        return ( ( ( c1.getSuit() == c2.getSuit() ) && ( c1.getSuit() == c3.getSuit() ) && 
                   ( c1.getSuit() == c4.getSuit() ) && ( c1.getSuit() == c5.getSuit() ) ) ? true : false );
    }

/***************************
 * isStraight() is used to determine if the hand is (or can be) a straight.  This version takes two Cards
 * as arguments and determines if they can be used as part of a straight.
 *
 * @param c1 The first Card
 * @param c2 The second Card
 * @return The value of the highest possible straight the cards can make. -1.0f if a straight cannot be made.
 *
 **/
...
//
        ...
        if ( c1val == c2val ) nopairs = false;
        if ( nopairs && ( ( c2val - c1val ) <= 4 ) ) {
            return ( ( ( c2val - c1val ) == 4 ) ? rankHand( (Card)cardList.get(1) ) : Math.min( (float)c1val + 4.0f, 14.0f ) );
        }
//
//    Special cases - Ace High and Low
//
        if ( c1val == Card.ACE ) {
            if ( nopairs && ( c1val <= Card.FIVE ) ) return 5.0f;
            if ( nopairs && ( c1val >= Card.TEN ) ) return 14.0f;
        }
//
//    No straight
//
...
/***************************
 * isStraight() is used to determine if the hand is (or can be) a straight.  This version takes three Cards
 * as arguments and determines if they can be used as part of a straight.
 *
 * @param c1 The first Card
 * @param c2 The second Card
...
//
        boolean nopairs = true;
        if ( ( c1val == c2val ) || ( c1val == c3val ) ) nopairs = false;
        if ( c2val == c3val ) nopairs = false;
        if ( nopairs && ( ( c3val - c1val ) <= 4 ) ) {
            return ( ( ( c3val - c1val ) == 4 ) ? rankHand( (Card)cardList.get(2) ) : Math.min( (float)c1val + 4.0f, 14.0f ) );    
        }
//
//    Special cases - Ace High and Low
//
        if ( c3val == Card.ACE ) {
            if ( nopairs && ( c2val <= Card.FIVE ) ) return 5.0f;
            if ( nopairs && ( c1val >= Card.TEN ) ) return 14.0f;
        }
//
//    No straight
...
/***************************
 * isStraight() is used to determine if the hand is (or can be) a straight.  This version takes four Cards
 * as arguments and determines if they can be used as part of a straight.
 *
 * @param c1 The first Card
 * @param c2 The second Card
...
//
        boolean nopairs = true;
        if ( ( c1val == c2val ) || ( c1val == c3val ) || ( c1val == c4val ) ) nopairs = false;
        if ( ( c2val == c3val ) || ( c2val == c4val ) ) nopairs = false;
        if ( c3val == c4val ) nopairs = false;
        if ( nopairs && ( ( c4val - c1val ) <= 4 ) ) {
            return ( ( ( c4val - c1val ) == 4 ) ? rankHand( (Card)cardList.get(3) ) : Math.min( (float)c1val + 4.0f, 14.0f ) );    
        }
//
//    Special cases - Ace High and Low
//
        if ( c4val == Card.ACE ) {
            if ( nopairs && ( c3val <= Card.FIVE ) ) return 5.0f;
            if ( nopairs && ( c1val >= Card.TEN ) ) return 14.0f;
        }
//
//    No straight
...
/***************************
 * isStraight() is used to determine if the hand is (or can be) a straight.  This version takes five Cards
 * as arguments and determines if they can be used as part of a straight.
 *
 * @param c1 The first Card
 * @param c2 The second Card
...
//
        boolean nopairs = true;
        if ( ( c1val == c2val ) || ( c1val == c3val ) || ( c1val == c4val ) || ( c1val == c5val ) ) nopairs = false;
        if ( ( c2val == c3val ) || ( c2val == c4val ) || ( c2val == c5val ) ) nopairs = false;
        if ( ( c3val == c4val ) || ( c3val == c5val ) ) nopairs = false;
        if ( c4val == c5val ) nopairs = false;
        if ( nopairs && ( ( c5val - c1val ) == 4 ) ) return rankHand( (Card)cardList.get(4) );
//
//    Special cases - Ace High and Low
//
        if ( c5val == Card.ACE ) {
            if ( nopairs && ( c4val == Card.FIVE ) && ( c1val == Card.TWO ) ) return 5.0f;
            if ( nopairs && ( c1val == Card.TEN ) ) return 14.0f;
        }
//
 ...
 *
 * @param r The floating point value of the hand.
 ...
 **/
    public static String nameHand( float r ) {
        if ( r >= 150.0f ) {
            ...
            return "Full House : " + nameCard( r - 90.0f ) + "s over " + nameCard( (r-k)*15.0f + 0.5f ) + "s";
        } else if ( r >= 75.0f ) {
            ...
            float k = (float)Math.floor( r );
            return "Two Pair : " + nameCard( r - 30.0f ) + "s and " + nameCard( (r-k)*15.0f ) + "s";
        } else if ( r >= 15.0f ) {
 ...
 *
 * @param r The floating point value of the card.
 * @return The String description of this card.
 *
 **/
    public static String nameCard ( float r ) {
        if ( r >= 14.0f ) return "Ace";
        if ( r >= 13.0f ) return "King";
        if ( r >= 12.0f ) return "Queen";
        if ( r >= 11.0f ) return "Jack";
        if ( r >= 10.0f ) return "Ten";
        if ( r >= 9.0f ) return "Nine";
        if ( r >= 8.0f ) return "Eight";
        if ( r >= 7.0f ) return "Seven";
        if ( r >= 6.0f ) return "Six";
        if ( r >= 5.0f ) return "Five";
        if ( r >= 4.0f ) return "Four";
        if ( r >= 3.0f ) return "Three";
        return "Two";
    }
}
